...
export const audits: AuditData[] = [
  {
    ...
    "category": "Blockchain L1 (Proof of Staked Authority)",
  ...
  },
  {
    ...
    "category": "Protocolo de Préstamos (DeFi)",
  ...
  // Proyecto 3 (C)
  {
    ...
    "category": "Protocolo de Préstamos",
  ...
  // Proyecto 4 (C+)
  {
    ...
    "category": "Herramienta de Gobernanza (DAO)",
  ...
  // Proyecto 5 (C)
  {
    ...
    "projectTicker": "YFARM",
    "client": "Anon Farmers",
    "category": "Agregador de Rendimiento",
  ...
  // Proyecto 7 (C)
  {
    ...
    "category": "Stablecoin Algorítmica",
  ...
  // Proyecto 9 (C)
  {
    ...
    "projectTicker": "MIX",
    "client": "Anon Devs",
    "category": "Mezclador de Privacidad",
